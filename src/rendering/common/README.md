...
| Submodule | Purpose |
|-----------|---------|
| `commands` | Lightweight command payloads used to submit render work |
| `components` | Shared rendering-related ECS components |
| `concepts` | Compile-time constraints for backend and handle categories |
| `types` | Small value types used across render pass and extraction code |
