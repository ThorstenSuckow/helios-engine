...
| Type | Description |
|------|-------------|
| `MaterialDomainTag` | Domain tag used for material IDs and handles |
| `MaterialId` | Strong id for material resources |
| `MaterialHandle` | ECS entity handle bound to `MaterialDomainTag` |
