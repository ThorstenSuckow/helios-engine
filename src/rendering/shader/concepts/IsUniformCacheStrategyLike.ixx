...
export namespace helios::engine::rendering::shader::concepts {
     ...
     * @details  Requires `bool cacheUniforms(TMemberHandle, ecs::EcsWorld&, UpdateContext&)`
    ...
    concept IsUniformCacheStrategyLike =
        ...
        requires(
        T& t, TMemberHandle entityHandle, ecs::EcsWorld& ecsWorld
    ) {
        {t.template cacheUniforms<TUniformScopes>(entityHandle, ecsWorld)} -> std::same_as<bool>;
    } &&  ...);
