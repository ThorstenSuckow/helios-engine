...
| Type | Description |
|------|-------------|
| `ShaderDomainTag` | Domain tag used for shader IDs and handles |
| `ShaderId` | Strong id for shader resources |
| `ShaderHandle` | ECS entity handle bound to `ShaderDomainTag` |
