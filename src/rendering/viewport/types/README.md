...
| Type | Description |
|------|-------------|
| `ViewportDomainTag` | Domain tag used for viewport IDs and handles |
| `ViewportId` | Strong id for viewport resources |
| `ViewportHandle` | ECS entity handle bound to `ViewportDomainTag` |
