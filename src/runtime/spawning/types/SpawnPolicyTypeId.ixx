...
export module helios.engine.runtime.spawning.types:SpawnPolicyTypeId;
 ...
 */
template<typename TEmitterHandle, typename TSpawnHandle>
struct std::hash<helios::engine::runtime::spawning::types::SpawnPolicyTypeId<TEmitterHandle, TSpawnHandle>> {
   std::size_t operator()(const helios::engine::runtime::spawning::types::SpawnPolicyTypeId<TEmitterHandle, TSpawnHandle>& id) const noexcept {
        return id.value();
    }
