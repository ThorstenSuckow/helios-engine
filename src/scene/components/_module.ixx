/**
 * @file _module.ixx
 * @brief Aggregate module for helios::engine::scene::components namespace.
 */


export module helios.engine.scene.components;
...
export import helios.engine.scene.components.ProjectionMatrixComponent;
export import helios.engine.scene.components.ViewMatrixComponent;